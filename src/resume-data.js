const resumeData = {
    ...
    lastName: 'Le',
    fullName: 'Tommy Le',
    email: 'tommyle225@gmail.com',
    address: '16417 Pascal Dr',
    state: 'LA',
    city: 'Prairieville',
    zip: '70769',
    summary:'Accomplished and motivated Software Engineer with 10+ years’ experience that can bring a diverse skill set and creative drive to software application development, proficient in Microsoft Technologies, writing code in various languages, and an enthusiastic team player.',
    education: { 
        year: '2003',
    ...
    urls:{
        linkedIn: 'http://www.linkedin.com/in/tommyle225'
    },
    technicalSkills:[
        '.NET Framework',
        ...
        'SharePoint, Nintex/Nintex Workflow',
